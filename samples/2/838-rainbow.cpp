...
void R(unsigned char* rainbow, unsigned char* hash);//衰减函数
...
void R(unsigned char* rainbow, unsigned char* hash)//衰减函数
{
	...
	int i;
	temp[0] = hash[0] + hash[18] + hash[6] + hash[13];
	temp[1] = hash[1] + hash[19] + hash[7] + hash[12];
	temp[2] = hash[3] + hash[17] + hash[8];
	temp[3] = hash[2] + hash[16] + hash[9];
