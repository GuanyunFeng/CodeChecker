...
int main()
{
    ...
    for(n=0;n<10;n++)
    {
        decryptSPN(x0,ciphertext,InitialKey);
        printf("dk(y%d)",10-n);
        /*
        for(i=0;i<128;i++)
        {
        ...
        */
        for(i=0;i<16;i++)
        {
            plaintext[i]=Arrayitonum(x0+8*i,8);
        ...
        for(i=0;i<16;i++)
        {
            output[i]=(char)(plaintext[i]);
        }
        output[16]='\0';
        printf("%s\n",output);
        printf("x%d=dk(y%d)^y%d\n",10-n,10-n,9-n);
        for(i=0;i<16;i++)
        {
            printf("%d",plaintext[i]^plaintext[i]);
        }
        //printf("\n");
        for(i=0;i<16;i++)
        {
            output[i]=(char)(plaintext[i]^plaintext[i]);
        }
        printf("%s\n",output);
    }
    printf("\n");
